...
#' @param metric.name character, name of the evaluation metric used;
              ...
              for(r in res) {
                ...
                if (!all(is.null(r$est.props)) && !all(is.na(r$est.props))) {
                    ...
                    for (t in intersect(
                      ...
                      df <- rbind(
                        df,
                        c(name, temp.score, t, geneset,
                          metric.name, time, fraction, cond.num)
                      )
                    }
                    # overall performance
                  ...
                  # if the deconvolution worked, evaluate with given metric
                  if (!all(is.null(r$est.props)) && !all(is.na(r$est.props))) {
                    # performance per cell type
                    common_ct <- intersect(
                      rownames(r$est.props),
