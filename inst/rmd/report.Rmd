...
load(paste(temp.dir, "/input_data/raw.rda", sep=""))
load(paste(temp.dir, "/input_data/processed.rda", sep=""))
```
...
Function call used to execute the benchmark: `r function.call`  
...
cond.num.plots <- plot_cond_num(real.df)
```
...
if(dir.exists(paste(temp.dir, "/results/simulation/samples", sep = ""))){
	...
	sample.plots <- create_boxplots(samples.df)
}
...
if(dir.exists(paste(temp.dir, "/results/simulation/genes", sep=""))){
	...
	gene.plots <- create_lineplots(genes.df, genesets, rownames(training.exprs))
}
```
