...
Corresponding phenotype data contained labels for `r length(unique(sc.pheno[[celltype.col]]))` cell types:
```{r}
...
overlapping features with provided single-cell data. (Pre-trained models are not considered here.)
