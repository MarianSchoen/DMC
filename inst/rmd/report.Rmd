...
The plotted value is the `r metric.name`, coded by rectangle size and color 
...
Bootstrapping performed to test the robustness of the chosen metric. 
...
The value is the `r metric.name`, coded by rectangle size and color 
(small to big, red to green with increasing performance). 
Negative and undefined scores were set to 0. 
...
Score is the `r metric.name`, averaged over multiple repetitions. 
