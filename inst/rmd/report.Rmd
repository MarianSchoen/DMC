...
plot(score.plot)
pdf(paste(plot.dir, "/score_plot_real.pdf"))
plot(score.plot)
dev.off()
```  
...
plot(runtime.plot)
pdf(paste(plot.dir, "/runtime_plot_real.pdf"))
plot(runtime.plot)
dev.off()
```  
...
pdf(paste(plot.dir, "/scatter_plots_real.pdf"))
for(l in scatter.plots.list){
	if(!is.null(l)){
		for(p in l){
			if(!is.null(p))
...
pdf(paste(plot.dir, "/condition_number_plots_real.pdf"))
plot(cond.num.plots$cond_num_plot)  
...
if(exists("bootstrap.data")){
  ...
  plot(bootstrap.plot)
  pdf(paste(plot.dir, "/bootstrap_plot_real.pdf"))
  plot(bootstrap.plot)
  dev.off()
}
```
...
if(exists("score.plot.sim")){
	plot(score.plot.sim)
  pdf(paste(plot.dir, "/score_plot_simulated.pdf"))
  plot(score.plot.sim)
  dev.off()
}
```  
...
if(exists("scatter.plots.list.sim")){
  ...
  pdf(paste(plot.dir, "/scatter_plots_simulated.pdf"))
	for(l in scatter.plots.list.sim){
		for(p in l){
			plot(p)
		}
...
if(exists("sample.plots")){
  ...
  pdf(paste(plot.dir, "/sample_plots_simulated.pdf"))
  for(p in sample.plots$cell.type.plots) plot(p)
  dev.off()
}
```  
...
if(exists("gene.plots")){
  ...
  pdf(paste(plot.dir, "/gene_time_plot_simulated.pdf"))
  plot(score.plot.sim)
  dev.off()
}
```  
...
if(exists("gene.plots")){
	for(p in gene.plots$cell.type.plots)
		plot(p)
  pdf(paste(plot.dir, "/gene_score_plots_simulated.pdf"))
	for(p in gene.plots$cell.type.plots)
		plot(p)
  dev.off()
}
...
if(exists("score.plot.subtype")){
  ...
  pdf(paste(plot.dir, "/subtype_plot.pdf"))
  plot(score.plot.subtype)
  dev.off()
}
```  
...
if(exists("runtime.plot.subtype")){
  ...
  pdf(paste(plot.dir, "/subtype_plot_runtime.pdf"))
  plot(runtime.plot.subtype)
  dev.off()
}
```  
