...
if(dir.exists(paste(temp.dir, "/results/simulation/subtypes", sep=""))){
	...
	if(length(files) > 0){
		...
		score.plot.subtype <- evaluation_plot(subtypes.df, "deconvolution quality (simulated subtypes)", metric, metric.name, celltype.order = celltypes.ordered, algorithm.order = algorithms.ordered)$plot
